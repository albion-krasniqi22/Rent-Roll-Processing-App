...
def standardization_instructions():
    ...
    - Amount: these are charges in dollar amount (which is different from charge code), Charges or credits, Scheduled Charges, Actual charges (do not rename Recurring Charges)
...
def get_columns_to_drop(columns):
    ...
    **Rules for Dropping Columns**:
    ...
    4. Be conservative:
        ...
        - If in doubt, retain the column. comrent keep, future lease (F), concessions, write off, amounts
